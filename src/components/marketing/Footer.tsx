      ...
      <div className="mx-auto max-w-7xl px-5 py-14 sm:px-8">
        <div className="grid grid-cols-2 gap-10 sm:grid-cols-3 lg:grid-cols-6">
          <div className="col-span-2 sm:col-span-3 lg:col-span-1">
            ...
            <p className="mt-4 max-w-[24ch] text-[13px] leading-relaxed text-ink-mute">
              Chat with your data — automatic EDA, charts, and reports without code.
            </p>
          </div>
          {FOOTER_COLS.map((col) => (
            <div key={col.heading}>
        ...
        <div className="mt-12 flex flex-col items-start justify-between gap-4 border-t border-line pt-6 sm:flex-row sm:items-center">
          <p className="text-[13px] text-ink-faint">
            © {year} DataLens. All rights reserved.
          </p>
          <div className="flex gap-5">
            ...
            <a href="mailto:hello@datalens.example.com" className="text-[13px] text-ink-soft hover:text-ink">
              hello@datalens.example.com
            </a>
          </div>
          <div className="flex gap-4">
            <a href="https://github.com" target="_blank" rel="noreferrer" aria-label="DataLens on GitHub" className="text-ink-faint transition-colors hover:text-ink">
            ...
            <a href="https://x.com" target="_blank" rel="noreferrer" aria-label="DataLens on X" className="text-ink-faint transition-colors hover:text-ink">
            ...
            <a href="https://linkedin.com" target="_blank" aria-label="DataLens on LinkedIn" rel="noreferrer" className="text-ink-faint transition-colors hover:text-ink">
